...
export interface UsersServiceClient {
  cresteUser(request: CreateUserDto): Observable<User>;
...
export interface UsersServiceController {
  cresteUser(request: CreateUserDto): Promise<User> | Observable<User> | User;
...
export function UsersServiceControllerMethods() {
  return function (constructor: Function) {
    const grpcMethods: string[] = ["cresteUser", "findAllUsers", "findOneUser", "updateUser", "removeUser"];
